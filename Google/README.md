...
| [`Audit Shared Drive Folder.ps1`](Audit%20Shared%20Drive%20Folder.ps1) | Audits a Google Drive folder for subfolder counts, file counts, external ownership, external sharing, and total sizes - outputs four reports (Summary, FolderDetails, FileDetails, FolderTree) for migration planning. Automatically detects legacy resource key-protected folders and prompts for the owner's email to impersonate |
